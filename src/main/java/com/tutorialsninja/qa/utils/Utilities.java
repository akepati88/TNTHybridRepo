...
public class Utilities {
	...
	// if we declare anymethod as satatic we can access from anywhere in project by importing package
	...
	public static Object[][] getTestDataFromExcel(String sheetName) {
		...
		for (int i =0 ; i<rows;i++) {
			...
			for (int j=0 ;j< cols ; j++ ) {
				...
				case NUMERIC:
					//int = typecasting password cell data to int from double 
					//Integer.toString = convers int data to String
